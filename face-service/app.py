...
#     print("No face encodings found, starting with empty database")
...
# except:
#     print("No emotion recognition model found")
...
# def recognize_faces(face_encodings_list):
#     recognized_faces = []
...
#     # Simple liveness detection (can be improved)
#     # This is a placeholder for more sophisticated liveness detection
#     return True, 0.95
...
#                 # Calculate attention score (placeholder)
#                 attention_score = 0.85  # This would be replaced with actual attention detection
#                 attention_data[face['user_id']] = attention_score
...
# def train_model():
#     try:
#         # This endpoint could be used to retrain or fine-tune models
...
# # this is second version of face recog model
